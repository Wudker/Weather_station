...
const uint8_t SET_DAY   = 19;
const uint8_t SET_WDAY  = 7;
const uint8_t SET_MONTH = 9;
const uint8_t SET_CENT  = 0;
const uint8_t SET_YEAR  = 26;
const uint8_t SET_HOUR  = 22;
const uint8_t SET_MIN   = 9;
const uint8_t SET_SEC   = 0;
bool bme_ok = false;
const int Hall_pin          = 17;
const int WaterSensor       = 19;
const int WaterSensorAnalog = 34;
const int Battery_level     = 35;
const int Fotopanel_level   = 33;
